    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-lg-3">
          ...
          <div class="card">
            <div class="card-header border-0">
              <h3 class="card-title">Total Penjual</h3>
              <div class="card-tools">
        ...
        <div class="col-lg-3">
          ...
          <div class="card">
            <div class="card-header border-0">
              <h3 class="card-title">Jumlah Lembaga/Komunitas</h3>
              <div class="card-tools">
                <a href="#" class="btn btn-sm btn-tool">
                  <i class="fas fa-download"></i>
                </a>
            ...
            <div class="card-body">
              <div class="d-flex flex-column justify-content-between align-items-center border-bottom mb-3">
                ...
                <p class="d-flex flex-column text-right">
                  <span class="font-weight-bold">
                    <i class="ion ion-android-arrow-up text-success"></i> {{ $community }}
                  </span>
                  <span class="text-muted">LEMBAGA/KOMUNITAS</span>
                </p>
              </div>
              <!-- /.d-flex -->
              {{-- <div class="d-flex justify-content-between align-items-center border-bottom mb-3">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="d-flex flex-column justify-content-between align-items-center border-bottom mb-3">
                ...
                <p class="d-flex flex-column text-right">
                  <span class="font-weight-bold">
                    <i class="ion ion-android-arrow-up text-success"></i> {{ $activity }}
                  </span>
