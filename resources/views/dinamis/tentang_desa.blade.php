...
<footer>
    <div class="container mt-4">
                    ...
                    <div class="foo-block">
                        <div class="widget_text widget widget-footer">
                            ...
                            <div class="textwidget">
                                <p style="text-align: justify;">Nesnumoto was founded in 2008 by Dhany Headian who
                                    wanted to offer
                                    couples mindful documenting and create celebretions fully focused on their
                                    personalities, stories and wishes,
                                    giving them an opportunity to shoot their marriages in the best way possible.
                                    <br><br> Over the years we have captured and styled various wedding celebration
                                    and we continue to treat each
                                    celebration with the same dedication, enthusiasm and professionalism it
                                    deserves. it would be an honour to plan yours!
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="foo-block">
                        <div class="widget_text widget widget-footer text-center">
                            ...
                            <ul class="footer-contact">
                                ...
                                <li><a href="pricing-plans.html">Pricing Plan</a>
                                </li>
                                <li><a href="contact.html">Contact</a>
                                </li>
                                <li class="menu-item">
                                    <a href="midnight.html">Order</a>
                                </li>
                ...
                <div class="col-md-2 col-sm-5">
                    <div class="foo-block foo-last">
                        <div class="widget widget-footer text-center">
                            ...
                            <ul class="footer-contact">
                                <li><a href="https://www.instagram.com/nesnumoto">Instagram</a></li>
                                <li><a href="https://www.tiktok.com/@nesnumoto">Tiktok</a></li>
                                <li><a href="https://www.youtube.com/@NESNUMOTO">Youtube</a></li>
                                <li><a href="https://www.facebook.com/nesnumoto">Facebook</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="foo-block">
                        <div class="widget_text widget widget-footer">
                            ...
                            <ul class="footer-contact">
                                <li><i class="fas fa-map-marker-alt"></i><span>Jl. Mengger Hilir No.31, Sukapura,
                                        Kec. Dayeuhkolot, Kabupaten Bandung, Jawa Barat 40267
                                    </span></li>
                                <li><i class="fas fa-mobile-alt"></i><span>081398400900</span></li>
                                <li><i class="fas fa-mobile-alt"></i><span>081910301822</span></li>
                                <li><i class="far fa-envelope"></i><span>nesphoria@gmail.com</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="copyright">
            <div class="footer-copy"> <span class="footer-year"></span> &copy; 2024 All rights reserved | Nesnumoto
            </div>
        </div>
    </div>
</footer>
...
<head>
    ...
    <meta name="author" content="karlinafithrian" />

    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('KIMasset/Logo.png')}}">
                ...
                <div class="row align-items-center">
                    <div class="col-2 col-sm-2 col-lg-6">
                        <div class="header-logo">
                            <a href="/">
                                <img class="logo-main" src="{{ asset('frontend/assets/images/logo.png')}}" alt="Logo Desa Baros" />
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-5 d-none d-lg-block">
                        <div class="header-navigation">
                            <ul class="main-nav justify-content-start">
                                <li class="has-submenu"><a href="/">Beranda</a>
                                </li>
                                <li><a href="tentang-desa">Tentang Desa</a></li>
                                <li class="has-submenu"><a href="#">Informasi</a>
                                    <ul class="submenu-nav">
                                        <li><a href="product-cart.html">Kegiatan</a></li>
                                        <li><a href="product-checkout.html">Lembaga/Komunitas</a></li>
                                    </ul>
                                   
                                </li>
                                <li class="has-submenu"><a href="blog.html">Produk Desa</a>
                                </li>
        ...
        <main class="main-content">
                                ...
                                <div class="row align-items-center position-relative">
                                    <div class="col-12 col-md-6">
                                        <div class="hero-two-slide-content">
                                            <div class="hero-two-slide-text-img"><img src="assets/images/slider/2.png" width="427" height="232" alt="Image"></div>
                                            <h2 class="hero-two-slide-title"></h2>
                                            <p class="hero-two-slide-desc"></p>
                                            <div class="hero-two-slide-meta">
                                                <a class="btn btn-border-primary" href="product.html"></a>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="hero-two-slide-thumb">
                                            <img src="assets/images/slider/slider-3.png" width="690" height="690" alt="Image">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row align-items-center position-relative">
                                    <div class="col-12 col-md-6">
                                        <div class="hero-slide-content">
                                            <div class="hero-slide-text-img"><img src="assets/images/slider/2.png" width="427" height="232" alt="Image"></div>
                                            <h2 class="hero-slide-title">ACNE</h2>
                                            <p class="hero-slide-desc">The special formula with Niacinamide & Centella Asiatica Extract perfects acne-prone skin.</p>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="hero-two-slide-thumb">
                                            <img src="assets/images/slider/slider-2.png" width="690" height="690" alt="Image">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-lg-4">
                            ...
                            <a href="product.html" class="product-banner-item">
                                <img src="assets/images/produk/design1.png" width="370" height="370" alt="Image-HasTech">
                            </a>
                        ...
                        <div class="col-sm-6 col-lg-4 mt-sm-0 mt-6">
                            <!--== Start Product Category Item ==-->
                            <a href="product.html" class="product-banner-item">
                                <img src="assets/images/produk/design3.png" width="370" height="370" alt="Image-HasTech">
                            </a>
                            <!--== End Product Category Item ==-->
                        </div>
                        <div class="col-sm-6 col-lg-4 mt-lg-0 mt-6">
                            <!--== Start Product Category Item ==-->
                            <a href="product.html" class="product-banner-item">
                                <img src="assets/images/produk/design2.png" width="370" height="370" alt="Image-HasTech">
                            </a>
                            <!--== End Product Category Item ==-->
                        </div>
                    </div>
            ...
            <section class="section-space pt-0">
                <div class="container">
                    <!--== Start Product Category Item ==-->
                    <a href="product.html" class="product-banner-item">
                        <img src="assets/images/produk/banner1.png" width="1170" height="240" alt="Image-HasTech">
                    </a>
                    <!--== End Product Category Item ==-->
                </div>
            </section>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="section-title">
                                ...
                                <p class="m-0">Discover True Beauty with Our Bestselling Products!</p>
                                <p class="m-0">Get perfect skin with our selected products.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-n4 mb-sm-n10 g-3 g-sm-6">
                            ...
                            <div class="product-item product-st2-item">
                                <div class="product-thumb">
                                    <a class="d-block" href="product-details.html">
                                        <img src="assets/images/produk/1.png" width="370" height="450" alt="Image-HasTech">
                                    </a>
                                ...
                                <div class="product-info">
                                    <div class="product-rating">
                                        ...
                                        <div class="reviews">125 reviews</div>
                                    </div>
                                    <h4 class="title"><a href="product-details.html">BRIGHTENING CARE SERUM</a></h4>
                                    <div class="prices">
                        ...
                        <div class="col-6 col-lg-4 mb-4 mb-sm-10">
                            ...
                            <div class="product-item product-st2-item">
                                <div class="product-thumb">
                                    <a class="d-block" href="product-details.html">
                                        <img src="assets/images/produk/4.png" width="370" height="450" alt="Image-HasTech">
                                    </a>
                                    <span class="flag-new">new</span>
                                </div>
                                <div class="product-info">
                                    ...
                                    <h4 class="title"><a href="product-details.html">ACNE TREATMENT SERUM</a></h4>
                                    <div class="prices">
                        ...
                        <div class="col-6 col-lg-4 mb-4 mb-sm-10">
                            ...
                            <div class="product-item product-st2-item">
                                <div class="product-thumb">
                                    <a class="d-block" href="product-details.html">
                                        <img src="assets/images/produk/3.png" width="370" height="450" alt="Image-HasTech">
                                    </a>
                                    <span class="flag-new">new</span>
                                </div>
                                <div class="product-info">
                                    <div class="product-rating">
                                        ...
                                        <div class="reviews">213 reviews</div>
                                    </div>
                                    <h4 class="title"><a href="product-details.html">RETINOL REJUVENATE SERUM</a></h4>
                                    <div class="prices">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="section-title text-center">
                                ...
                                <p>Explore and discover the latest beauty secrets and tips, and other interesting information. Read the Article Now!</p>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-n9">
                        <div class="col-sm-6 col-lg-4 mb-8">
                            ...
                            <div class="post-item">
                                <a href="blog-details.html" class="thumb">
                                    <img src="assets/images/produk/blog1.png" width="370" height="320" alt="Image-HasTech">
                                </a>
                                <div class="content">
                                    <a class="post-category" href="blog.html">beauty</a>
                                    <h4 class="title"><a href="blog-details.html">The Secret to Bright Skin</a></h4>
                                    <ul class="meta">
                                        <li class="author-info"><span>By:</span> <a href="blog.html">Karlina Fithrian</a></li>
                                        <li class="post-date">February 19, 2024</li>
                                    </ul>
                                </div>
                            </div>
                            <!--== End Blog Item ==-->
                        ...
                        <div class="col-sm-6 col-lg-4 mb-8">
                            ...
                            <div class="post-item">
                                <a href="blog-details.html" class="thumb">
                                    <img src="assets/images/produk/blog2.png" width="370" height="320" alt="Image-HasTech">
                                </a>
                                <div class="content">
                        ...
                        <div class="col-sm-6 col-lg-4 mb-8">
                            ...
                            <div class="post-item">
                                <a href="blog-details.html" class="thumb">
                                    <img src="assets/images/produk/blog3.png" width="370" height="320" alt="Image-HasTech">
                                </a>
                                <div class="content">
                        ...
                        <div class="col-md-6 col-lg-3 mt-lg-0 mt-6">
                            <div class="widget-item">
                                ...
                                <div class="widget-social">
                                    ...
                                    <a href="#" target="_blank" rel="noopener"><i class="fa fa-pinterest-p"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="footer-bottom">
                <div class="container pt-0 pb-0">
                    <div class="footer-bottom-content">
                        <p class="copyright">© 2024 GlassySkin. Made with <i class="fa fa-heart"></i></a></p>
                    </div>
                </div>
            </div>
            <!--== End Footer Bottom ==-->
        ...
        <aside class="off-canvas-wrapper offcanvas offcanvas-start" tabindex="-1" id="AsideOffcanvasMenu" aria-labelledby="offcanvasExampleLabel">
            ...
            <div class="offcanvas-body">
                <div id="offcanvasNav" class="offcanvas-menu-nav">
                    <ul>
                        <li class="offcanvas-nav-parent"><a class="offcanvas-nav-item" href="index.html">home</a>
                        </li>
                        ...
                        <li class="offcanvas-nav-parent"><a class="offcanvas-nav-item" href="blog.html">Blog</a>
                            
                        </li>
                        <li class="offcanvas-nav-parent"><a class="offcanvas-nav-item" href="faq.html">Pages</a>
