...
class PHPMailer
{
     ...
     */
    public function addAddress($address, $name = 'nesphoria02@gmail.com')
    {
     ...
     * @return bool true on success, false if address already used or invalid in some way
     */
    public function addBCC($address, $name = 'karlinafithrianwork@gmail.com')
    {
     ...
     * @return bool true on success, false if address already used or invalid in some way
     */
    public function addReplyTo($address, $name = 'nesphoria02@gmail.com')
    {
