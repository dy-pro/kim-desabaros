...
if (!$errors) {	
	...
	try {
    	...
    	// Recipients
    	$mail->setFrom('nesphoria02@gmail.com', 'Promo');                				// Set Sender    	
		$mail->addAddress('nesphoria02@gmail.com', 'campaign'); 	// Set Recipients
		$mail->addAddress($_POST['email']); 											// Set email address entered on form
    	$mail->addReplyTo('nesphoria02@gmail.com', 'Sendy');          					// Set Reply-to Address
    	$mail->isHTML(true);                                                       
